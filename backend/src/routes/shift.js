...
router.post('/api/shifts/roster/update', verifyToken, requirePermission(PERMISSIONS.MANAGE_WORKFORCE), requireStationAccess, requirePlatformAccess, requireAreaAccess, shiftController.reassignWorkerShift);
