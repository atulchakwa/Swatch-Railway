...
router.post('/api/shifts/roster/update', verifyToken, requirePermission(PERMISSIONS.ASSIGN_SHIFT), requireStationAccess, requirePlatformAccess, requireAreaAccess, shiftController.reassignWorkerShift);
