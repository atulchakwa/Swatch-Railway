...
class PDFReportService {
  ...
  static pw.Widget _buildCheckMark() {
    return pw.SvgImage(
      svg:
          '<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',
      width: 10,
      height: 10,
    );
  }
  ...
  static pw.Widget _buildCrossMark() {
    return pw.SvgImage(
      svg:
          '<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',
      width: 10,
      height: 10,
    );
  }
  ...
  static pw.Widget _buildHeader(
    pw.ImageProvider logo1,
    pw.ImageProvider logo2,
    String title,
    String status,
  ) {
    return pw.Container(
            ...
            children: [
              ...
              pw.Column(
                ...
                children: [
                  ...
                  pw.Text(
                    'Indian Railways - Station Cleaning Enterprise Monitoring System',
              ...
              pw.Column(
                ...
                children: [
                  pw.Container(
                    ...
                    decoration: pw.BoxDecoration(
                      color: status == 'COMPLIANT' || status == 'RESOLVED'
                          ? successColor
                          : warningColor,
  ...
  static pw.Widget _buildSignatures({
    String? supervisorSignatureBase64,
    String? officialSignatureBase64,
  }) {
    pw.ImageProvider? supervisorImg;
    pw.ImageProvider? officialImg;
    try {
      if (supervisorSignatureBase64 != null &&
          supervisorSignatureBase64.isNotEmpty) {
        supervisorImg = pw.MemoryImage(base64Decode(supervisorSignatureBase64));
      }
      if (officialSignatureBase64 != null &&
          officialSignatureBase64.isNotEmpty) {
            ...
            children: [
              ...
              pw.Column(
                children: [
                  ...
                  pw.Text(
                    'Station Cleaning Monitoring System',
                    style: const pw.TextStyle(fontSize: 8),
                  ),
                ],
              ),
  ...
  static pw.Widget _buildRatingScoreRow(
    String label,
    double score,
    int count,
    String weight,
    ...
    final PdfColor barColor = score >= 4
        ? successColor
        : score >= 3
        ? warningColor
  ...
  static Future<pw.ImageProvider?> _fetchImageBytes(String? url) async {
    if (url == null || url.trim().isEmpty || url == 'captured' || url == 'N/A')
      return null;
    try {
  ...
  static pw.Widget _buildAuditHeader(
    pw.ImageProvider logo1,
    String title,
    String subtitle,
    String statusTitle,
                ...
                pw.Row(
                  ...
                  children: [
                    pw.Container(
                      ...
                      height: 16,
                      decoration: pw.BoxDecoration(
                        color: isSuccess ? successColor : warningColor,
  ...
  static Future<Uint8List> generateWorkerActivityReportPdf(
    List<dynamic> runs,
    List<dynamic> tasks,
  ) async {
      ...
      pw.MultiPage(
        ...
        build: (pw.Context context) {
          ...
          for (final run in runs) {
            ...
            final runTasks = tasks
                .where((t) => t['runInstanceId'] == runId)
                .toList();
            ...
            for (final coach in coaches) {
                ...
                pw.Container(
                  ...
                  child: pw.Column(
                    children: [
                      ...
                      _buildInfoRow(
                        'Direction',
                        run['direction']?.toString() ?? 'Outbound',
                        'Run Date',
                        run['departureDate'] ??
              ...
              content.add(
                _buildAuditSectionHeader(
                  '3. TASK EXECUTION & EVIDENCE DETAILS',
                ),
              );
              if (workerTasks.isEmpty) {
                content.add(
                  pw.Text(
                    'No task records found for worker in this run.',
                        ...
                        return pw.TableRow(
                          ...
                          children: [
                            ...
                            pw.Padding(
                              padding: const pw.EdgeInsets.all(4),
                              child: pw.Text(
                                task['coachNo']?.toString() ??
                                    cm['coachPosition']?.toString() ??
                                    'C1',
                                style: const pw.TextStyle(fontSize: 7),
                                textAlign: pw.TextAlign.center,
                              ),
                          ...
                          pw.Container(
                            ...
                            child: pw.Column(
                              children: [
                                ...
                                _buildInfoRow(
                                  'Passenger Rating',
                                  cm['passengerRating']?.toString() ?? '5 / 5',
          ...
          if (runs.isEmpty ||
              runs.every(
                (r) => (r['coaches'] as List<dynamic>? ?? []).isEmpty,
              )) {
            content.add(
              pw.Text(
                'No worker assignments found in the selected runs.',
                style: const pw.TextStyle(fontSize: 10),
              ),
            );
          }
  ...
  // 2. Complaint Report
  static Future<Uint8List> generateComplaintReportPdf(
    List<dynamic> runs,
      ...
      pw.MultiPage(
        ...
        build: (pw.Context context) {
          ...
          final widgets = <pw.Widget>[
            _buildAuditHeader(
              railway,
              'OBHS WORKER COMPLAINT &\nISSUE TRACKING REPORT',
              'Resolution Tracking | Escalation Audit | Evidence Verification',
              statusTitle,
              statusValue,
              isResolved,
            ),
            ...
            _buildAuditSectionHeader(
              '1. COMPLAINT & ISSUE TRACKING KPI SUMMARY',
            ),
            pw.Container(
              padding: const pw.EdgeInsets.all(10),
              decoration: pw.BoxDecoration(
          ...
          for (final c in complaints) {
            ...
            final run = runs.firstWhere(
              (r) => r['runInstanceId'] == runId || r['instanceId'] == runId,
            ...
            widgets.addAll([
              ...
              _buildAuditSectionHeader(
                'COMPLAINT ID: ${c['complaintId']?.toString().substring(0, 8) ?? 'N/A'}',
              ),
              ...
              pw.Container(
                ...
                child: pw.Column(
                  children: [
                    _buildInfoRow(
                      'Train Name',
                      run['trainName']?.toString() ?? 'N/A',
                      'Train Number',
                      run['trainNo']?.toString() ?? 'N/A',
                    ),
                    _buildInfoRow(
                      'Run ID',
                      runId,
                      'Run Date',
                      run['departureDate']?.toString() ?? 'N/A',
                    ),
                    _buildInfoRow(
                      'Direction',
                      run['direction']?.toString() ?? 'Outbound',
                      'Division',
                      run['division']?.toString() ?? 'N/A',
                    ),
                    _buildInfoRow(
                      'Supervisor',
                      run['supervisorName']?.toString() ?? 'N/A',
                      'Base Station',
                      run['baseStation']?.toString() ?? 'N/A',
                    ),
                  ],
                ),
              ),
                ...
                child: pw.Column(
                  children: [
                    ...
                    _buildInfoRow(
                      ...
                      c['type']?.toString() ?? 'N/A',
                      'Priority Level',
                      c['priority']?.toString() ?? 'Normal',
                    ),
                    _buildInfoRow(
                      'Status',
                      c['status']?.toString() ?? 'IN PROGRESS',
                      'Complaint Date',
                      c['createdAt'] != null
                          ? DateFormat(
                              'dd-MMM-yyyy hh:mm a',
                    ...
                    _buildInfoRow(
                      'Raised By',
                      c['janitorName']?.toString() ?? 'N/A',
                      'GPS Location',
                      c['gpsLocation']?.toString() ?? 'N/A',
                    ),
                  ],
                ),
              ),
              ...
              pw.SizedBox(height: 10),
              _buildObservationBlock(
                'This complaint is actively being tracked and escalated to the respective division authorities. SLA tracking has been enabled to ensure prompt resolution within designated service hours.',
              ),
              pw.SizedBox(height: 10),
            ]);
          }
      ...
      pw.MultiPage(
        ...
        build: (pw.Context context) {
          final widgets = <pw.Widget>[
            _buildAuditHeader(
              railway,
              'OBHS ENTERPRISE TRAIN RUN &\nOPERATIONAL AUDIT REPORT',
              'Journey Audit | Worker Assignment Verification | Compliance Overview',
              ...
              pw.Container(
                ...
                child: pw.Column(
                  children: [
                    _buildInfoRow(
                      'Train Name',
                      r['trainName']?.toString() ?? 'N/A',
                      'Train Number',
                      r['trainNo']?.toString() ?? 'N/A',
                    ),
                    _buildInfoRow(
                      'Run Instance ID',
                      (r['runInstanceId'] ?? r['instanceId'] ?? 'N/A')
                          .toString(),
                      'Service Pair ID',
                      r['instanceId']?.toString() ?? 'N/A',
                    ),
                    _buildInfoRow(
                      'Direction',
                      r['direction']?.toString() ?? 'Outbound',
                      'Run Date',
                      r['departureDate']?.toString() ?? 'N/A',
                    ),
                    _buildInfoRow(
                      'Base Station',
                      r['baseStation']?.toString() ?? 'N/A',
                      'Destination',
                      r['destinationStation']?.toString() ?? 'N/A',
                    ),
                    _buildInfoRow(
                      'Run Status',
                      r['status']?.toString() ?? 'N/A',
                      'Division',
                      r['division']?.toString() ?? 'N/A',
                    ),
                    _buildInfoRow(
                      'Supervisor',
                      r['supervisorName']?.toString() ?? 'N/A',
                      'Total Coaches',
                        ...
                        pw.Container(
                          ...
                          child: pw.Column(
                            children: [
                              ...
                              _buildInfoRow(
                                'Overall Rating',
                                r['weightedScore']?.toString() ?? '4.8 / 5.0',
                  ...
                  pw.Expanded(
                    ...
                    child: pw.Column(
                      ...
                      children: [
                        ...
                        _buildObservationBlock(
                          'This enterprise audit report verifies that the train run completed its scheduled journey with all OBHS resources successfully assigned and operational targets met. Overall service delivery was compliant with railway standards.',
                        ),
                      ],
                    ),
                  ),
      ...
      pw.MultiPage(
        ...
        build: (pw.Context context) {
            ...
            pw.Container(
              ...
              child: pw.Column(
                children: [
                  ...
                  _buildInfoRow(
                    'Attendance Compliance',
                    '${attendance.isEmpty ? 0 : (attendance.where((a) => (a['status']?.toString() ?? '') != 'Absent').length / attendance.length * 100).toStringAsFixed(0)}%',
                    'GPS Validation',
                    'Verified',
                  ),
                ],
          ...
          for (final run in runs) {
            final runId = (run['runInstanceId'] ?? run['instanceId'] ?? '')
                .toString();
            final runAtt = attendance
                .where((a) => a['runInstanceId']?.toString() == runId)
                .toList();
            ...
            widgets.addAll([
              ...
              _buildAuditSectionHeader(
                '3. ATTENDANCE COMPLIANCE & EVIDENCE DETAILS',
              ),
              pw.Table(
                border: pw.TableBorder.all(color: borderColor, width: 0.5),
                columnWidths: const {
                ...
                children: [
                  ...
                  ...runAtt.map((a) {
                    final isPresent =
                        (a['status']?.toString() ?? 'Present') == 'Present';
                    final url = a['photoUrl']?.toString();
                      ...
                      children: [
                        pw.Padding(
                          ...
                          child: pw.Column(
                            ...
                            children: [
                              ...
                              pw.Text(
                                '${a['janitorName'] ?? 'N/A'} (${a['janitorId'] ?? 'N/A'})',
                                style: const pw.TextStyle(fontSize: 7),
                              ),
                            ],
                          ),
                        ...
                        pw.Padding(
                          ...
                          child: image != null
                              ...
                              : pw.Text(
                                  isPresent ? 'Missing Evidence' : 'N/A',
                                  style: const pw.TextStyle(
                                    fontSize: 7,
                                    color: PdfColors.red,
                                  ),
                        ...
                        pw.Padding(
                          padding: const pw.EdgeInsets.all(4),
                          child: pw.Text(
                            isPresent ? 'Completed' : 'Absent',
                            style: pw.TextStyle(
                              fontSize: 7,
                              color: isPresent ? successColor : PdfColors.red,
                              fontWeight: pw.FontWeight.bold,
                            ),
                            textAlign: pw.TextAlign.center,
                          ),
                  ...
                  pw.Expanded(
                    ...
                    child: pw.Column(
                      ...
                      children: [
                        _buildAuditSectionHeader('FINAL AUDIT OBSERVATION'),
                        _buildObservationBlock(
                          'This attendance audit report confirms that the assigned OBHS worker completed all mandatory attendance checkpoints with valid timestamp, GPS location tracking, and uploaded photographic evidence. All attendance records were successfully synchronized.',
                        ),
                      ],
                    ),
                  ),
  ...
  static Future<Uint8List> generateRatingsReportPdf(
    ...
    double avgForType(String type) {
      final list = feedbacks
          .where((f) => (f['raterType'] ?? '') == type)
          .toList();
      if (list.isEmpty) return 0;
      final sum = list.fold<double>(
        0,
        (s, f) => s + ((f['overallRating'] as num?)?.toDouble() ?? 0),
      );
      return sum / list.length;
    }

    int countForType(String type) =>
        feedbacks.where((f) => (f['raterType'] ?? '') == type).length;
    ...
    if (countForType('Passenger') > 0) {
      totalScore += passengerAvg * 0.40;
      totalWeight += 0.40;
    }
    if (countForType('Official') > 0) {
      totalScore += officialAvg * 0.25;
      totalWeight += 0.25;
    }
    if (countForType('Supervisor/Admin') > 0) {
      totalScore += supervisorAvg * 0.20;
      totalWeight += 0.20;
    }
    if (countForType('TTE') > 0) {
      totalScore += tteAvg * 0.10;
      totalWeight += 0.10;
    }
    if (countForType('PSME') > 0) {
      totalScore += psmeAvg * 0.05;
      totalWeight += 0.05;
    }
        ...
        build: (pw.Context context) {
          return [
            _buildHeader(
              railway,
              mirtha,
              'OBHS RATINGS & FEEDBACK AGGREGATION REPORT',
              'VERIFIED',
            ),
                ...
                children: [
                  ...
                  pw.Column(
                    ...
                    children: [
                      ...
                      pw.SizedBox(height: 4),
                      pw.Text(
                        'Weights: Passenger 40% | Official 25% | Sup.Admin 20% | TTE 10% | PSME 5%',
                        style: const pw.TextStyle(
                          color: PdfColors.grey400,
                          fontSize: 8,
                        ),
            ...
            pw.Container(
              ...
              child: pw.Column(
                children: [
                  _buildRatingScoreRow(
                    'Passenger',
                    passengerAvg,
                    countForType('Passenger'),
                    '40%',
                  ),
                  _buildRatingScoreRow(
                    'Official Inspector',
                    officialAvg,
                    countForType('Official'),
                    '25%',
                  ),
                  _buildRatingScoreRow(
                    'Supervisor / Admin',
                    supervisorAvg,
                    countForType('Supervisor/Admin'),
                    '20%',
                  ),
                  _buildRatingScoreRow(
                    'TTE',
  ...
  static Future<Uint8List> generateBillingReportPdf(
          ...
          return [
            ...
            pw.Container(
              ...
              child: pw.Column(
                children: [
                  _buildInfoRow(
                    'Bill ID',
                    bill['uid']?.toString() ?? 'N/A',
                    'Period',
                    bill['period']?.toString() ?? 'N/A',
                  ),
                  _buildInfoRow(
                    'Contract',
                    bill['contractNumber']?.toString() ?? 'N/A',
                    'Entity',
                    bill['entityName']?.toString() ?? 'N/A',
                  ),
                  _buildInfoRow(
                    'Zone',
                    bill['zone']?.toString() ?? 'N/A',
                    'Division',
                    bill['division']?.toString() ?? 'N/A',
                  ),
                  _buildInfoRow(
                    'Contract Value',
                    'Rs. ${(bill['contractValue'] ?? 0).toString()}',
                    'Grade',
                    bill['grade']?.toString() ?? 'N/A',
                  ),
                  _buildInfoRow(
                    'Overall Score',
                    '${bill['overallScore']?.toString() ?? '0'}%',
                    'Status',
                    bill['status']?.toString() ?? 'N/A',
                  ),
                ],
              ),
            ),
              ...
              child: pw.Column(
                children: [
                  _buildInfoRow(
                    ...
                    'Rs. ${(bill['contractValue'] ?? 0).toString()}',
                    'Total Deduction',
                    '-Rs. ${(bill['totalDeduction'] ?? 0).toString()}',
                  ),
                  ...
                  pw.Row(
                    ...
                    children: [
                      ...
                      pw.Text(
                        'Rs. ${(bill['finalPayable'] ?? 0).toString()}',
                        style: pw.TextStyle(
                          fontWeight: pw.FontWeight.bold,
                          fontSize: 16,
                          color: successColor,
            ...
            _buildSignatures(
              supervisorSignatureBase64:
                  bill['supervisorSignatureBase64'] ??
                  bill['submittedBySignatureBase64'],
              officialSignatureBase64:
                  bill['officialSignatureBase64'] ??
                  bill['approvedBySignatureBase64'],
            ),
          ];
        },
      ),
  ...
  static Future<Uint8List> generateCleaningFormReportPdf(
        ...
        build: (pw.Context context) {
          return [
            _buildHeader(
              railway,
              mirtha,
              '${isCoach ? "COACH" : "PREMISE"} CLEANING FORM',
              status.toUpperCase(),
            ),
            ...
            _buildInfoRow(
              'Form Type',
              isCoach ? 'Coach Cleaning' : 'Premise Cleaning',
              '',
              '',
            ),
            ...
            if (isCoach && form['coachDetails'] != null) ...[
              ...
              _buildInfoRow(
                'Train Number',
                form['coachDetails']['trainNumber'] ?? 'N/A',
                '',
                '',
              ),
              _buildInfoRow(
                'Train Name',
                form['coachDetails']['trainName'] ?? 'N/A',
                '',
                '',
              ),
              _buildInfoRow(
                'Coach Number',
                form['coachDetails']['coachNumber'] ?? 'N/A',
                '',
                '',
              ),
              _buildInfoRow(
                'Coach Type',
                form['coachDetails']['coachType'] ?? 'N/A',
                '',
                '',
              ),
              _buildInfoRow(
                'Watering Done',
                form['coachDetails']['wateringDone'] == true ? 'Yes' : 'No',
                '',
                '',
              ),
              _buildInfoRow(
                'Toiletries',
                form['coachDetails']['toiletriesAvailable'] == true
                    ? 'Available'
                    : 'Not Available',
                '',
                '',
              ...
              _buildInfoRow(
                'Dustbins',
                form['coachDetails']['dustbinsAvailable'] == true
                    ? 'Available'
                    : 'Not Available',
                '',
                '',
            ...
            if (!isCoach && form['premiseDetails'] != null) ...[
              ...
              _buildInfoRow(
                'Premise Name',
                form['premiseDetails']['premiseName'] ?? 'N/A',
                '',
                '',
              ),
              _buildInfoRow(
                'Premise Type',
                form['premiseDetails']['premiseType'] ?? 'N/A',
                '',
                '',
              ),
              _buildInfoRow(
                'Area Covered',
                '${form['premiseDetails']['areaCovered'] ?? 0} sq.m',
                '',
                '',
              ),
              _buildInfoRow(
                'Area Uncleaned',
                '${form['premiseDetails']['areaUncleaned'] ?? 0} sq.m',
                '',
                '',
              ),
              _buildInfoRow(
                'Garbage Collected',
                '${form['premiseDetails']['garbageCollected'] ?? 0} kg',
                '',
                '',
              ),
            ],
            if (form['remarks'] != null &&
                form['remarks'].toString().isNotEmpty) ...[
              pw.SizedBox(height: 10),
            ...
            if (form['scoringData'] != null &&
                form['scoringData']['criteria'] != null) ...[
              pw.SizedBox(height: 8),
              pw.TableHelper.fromTextArray(
                context: context,
                headerStyle: pw.TextStyle(
                ...
                data: <List<String>>[
                  ...
                  ...(form['scoringData']['criteria'] as List).map(
                    (c) => [
                      c['name'] ?? '',
                      '${c['maxScore'] ?? 10}',
                      '${c['score'] ?? 0}',
            ...
            if (form['photos'] != null &&
                (form['photos'] as List).isNotEmpty) ...[
              _buildInfoRow(
                'Total Photos',
                '${(form['photos'] as List).length}',
                '',
                '',
              ),
              _buildInfoRow(
                'Before Photos',
                '${(form['photos'] as List).where((p) => p['type'] == 'before').length}',
                '',
                '',
              ),
              _buildInfoRow(
                'After Photos',
                '${(form['photos'] as List).where((p) => p['type'] == 'after').length}',
                '',
                '',
              ),
            ] else ...[
            ...
            if (form['gpsAddress'] != null &&
                form['gpsAddress'].toString().isNotEmpty)
            ...
            if (form['approvedByName'] != null) ...[
              ...
              _buildInfoRow(
                ...
                form['approvedAt'] != null
                    ? DateFormat(
                        'dd-MMM-yyyy hh:mm a',
                      ).format(DateTime.parse(form['approvedAt']))
                    : 'N/A',
                '',
                '',
              ),
            ...
            if (form['lockedAt'] != null)
              _buildInfoRow(
                ...
                DateFormat(
                  'dd-MMM-yyyy hh:mm a',
                ).format(DateTime.parse(form['lockedAt'])),
                '',
                '',
              ),
            ...
            _buildSignatures(
              supervisorSignatureBase64:
                  form['supervisorSignatureBase64'] ??
                  form['submittedBySignatureBase64'],
              officialSignatureBase64:
                  form['officialSignatureBase64'] ??
                  form['approvedBySignatureBase64'],
            ),
          ];
        },
      ),
  ...
  static Future<Uint8List> generateStationCleaningFormReportPdf(
    Map<String, dynamic> form,
  ) async {
    final pdf = pw.Document();
    final railway = await _getRailwayLogo();
        ...
        build: (pw.Context context) {
          return [
            _buildHeader(
              railway,
              mirtha,
              'STATION CLEANING FORM',
              (form['status'] ?? 'draft').toString().toUpperCase(),
            ),
            _buildSectionHeader('1. FORM DETAILS'),
            _buildInfoRow('Form ID', form['formId'] ?? 'N/A', '', ''),
            ...
            _buildInfoRow(
              'Area Covered',
              '${form['areaCovered'] ?? 0} sq.m',
              '',
              '',
            ),
            _buildInfoRow(
              'Area Uncleaned',
              '${form['areaUncleaned'] ?? 0} sq.m',
              '',
              '',
            ),
            _buildInfoRow(
              'Garbage Collected',
              '${form['garbageCollected'] ?? 0} kg',
              '',
              '',
            ),
            pw.SizedBox(height: 10),
            ...
            if (form['activities'] != null &&
                (form['activities'] as List).isNotEmpty)
              ...(form['activities'] as List).map(
                (a) => pw.Paragraph(
                  text: '• $a',
  ...
  static Future<Uint8List> generateStationBillingPdf(
              ...
              child: pw.Column(
                children: [
                  ...
                  _buildInfoRow(
                    ...
                    '₹${pack.monthlyContractValue}',
                    '',
                    '',
                  ),
                  _buildInfoRow(
                    'Total Deductions',
                    '₹${pen['totalPenaltyAmount'] ?? 0}',
                    '',
                    '',
                  ),
                  pw.Divider(thickness: 1, color: borderColor),
  ...
  static Future<Uint8List> generateStationReportPdf(
    ...
    final title = _reportDisplayTitle(report.reportType);
    final reference = _reportReference(report);
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (pw.Context context) {
          ...
          final widgets = <pw.Widget>[
            _buildReportHeader(railway, mirtha, title, reference, timestamp),
            pw.SizedBox(height: 12),
            _buildMetaBlock(report, title, timestamp),
            pw.SizedBox(height: 12),
          ];

          if (scalarEntries.isNotEmpty) {
            widgets.add(_buildSectionHeader('Key Metrics'));
            final gridEntries = scalarEntries.length <= 12
                ? scalarEntries
                : scalarEntries.sublist(0, 12);
            widgets.add(_buildMetricGrid(gridEntries));
            widgets.add(pw.SizedBox(height: 8));
          }

          // Render any remaining scalar fields (beyond the KPI grid) as a detail list.
          if (scalarEntries.length > 12) {
            final rest = scalarEntries.sublist(12);
            final detailMap = <String, dynamic>{
              for (final e in rest) _formatLabel(e.key): e.value,
            };
            widgets.add(
              _buildSectionHeader(
                'Additional Details',
                color: const PdfColor.fromInt(0xff2c7fb8),
              ),
            );
            widgets.add(_buildBreakdownTable(detailMap));
            widgets.add(pw.SizedBox(height: 8));
          }
          ...
          for (final entry in arrayEntries) {
            ...
            final mappedColumns =
                (_reportArrayColumns[report.reportType] ?? const {})[entry.key];
          ...
          if (feedbackEntry != null && feedbackEntry.value.isNotEmpty) {
            final mappedColumns =
                (_reportArrayColumns[report.reportType] ??
          ...
          widgets.add(pw.Divider(thickness: 1, color: borderColor));
          widgets.add(pw.SizedBox(height: 8));
          widgets.add(_buildSignatures());
          widgets.add(_buildDigitalFooter(timestamp));
          return widgets;
  ...
  static String _reportDisplayTitle(String reportType) {
    return switch (reportType) {
      'daily_attendance' => 'Daily Attendance Report',
      'daily_activity' => 'Cleaning Activity Report',
      'daily_feedback' => 'Passenger Feedback Report',
      'daily_inspection' => 'Inspection Report',
      'daily_petty_issue' => 'Petty Issue Report',
      'missed_activity' => 'Overdue / Missed Task Exception Report',
      'daily_scorecard' => 'Daily Scorecard Report',
      'daily_complaint' => 'Complaint Report',
      'daily_supervisor_log' => 'Supervisor Daily Log',
      'monthly_attendance' => 'Monthly Attendance Report',
      'monthly_cleaning' => 'Monthly Cleaning Summary',
      'monthly_scorecard' => 'Monthly Scorecard Summary',
      'monthly_complaint' => 'Monthly Complaint Summary',
      'monthly_feedback' => 'Monthly Feedback Summary',
      'monthly_billing' => 'Billing Support Report',
      'monthly_penalty' => 'Monthly Penalty Report',
      'monthly_performance' => 'Performance Score Report',
      'monthly_petty_issue' => 'Monthly Petty Issue Summary',
      'archive_retrieval' => 'Archive Retrieval Report',
      _ => reportType.replaceAll('_', ' ').toUpperCase(),
    };
  }

  static String _reportReference(StationReport report) {
    final slug = report.reportType
        .replaceAll(RegExp(r'^(daily|monthly)_'), '')
        .toUpperCase();
    final period = report.reportType.startsWith('monthly')
        ? '${report.month.toString().padLeft(2, '0')}/${report.year}'
        : report.date.replaceAll('-', '');
    return 'REF-SC-${slug.substring(0, slug.length > 6 ? 6 : slug.length).toUpperCase()}-${report.stationId.substring(0, report.stationId.length > 4 ? 4 : report.stationId.length).toUpperCase()}-$period';
  }
      ...
      child: pw.Column(
        ...
        children: [
          ...
          pw.Padding(
            ...
            child: pw.Row(
              children: [
                pw.Image(logo1, width: 46, height: 46),
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      pw.Container(
                        ...
                        decoration: pw.BoxDecoration(
                          color: const PdfColor.fromInt(0xffeef4fb),
                          borderRadius: pw.BorderRadius.circular(4),
                        ),
                        child: pw.Text(
                          'Status: SYSTEM GENERATED • Digitally Verified',
                          style: pw.TextStyle(
                            fontSize: 8,
                            color: primaryColor,
                            fontWeight: pw.FontWeight.bold,
                ...
                pw.Column(
                  crossAxisAlignment: pw.CrossAxisAlignment.end,
                  children: [
                    pw.Image(logo2, width: 46, height: 46),
                    pw.SizedBox(height: 4),
                    pw.Text(
                      'Generated',
                      style: pw.TextStyle(
  ...
  static pw.Widget _buildMetaBlock(
    StationReport report,
    String title,
    String timestamp,
  ) {
    ...
    final period = hasRange
        ...
        : (report.reportType.startsWith('monthly')
    ...
    return pw.Table(
      ...
      children: [
        pw.TableRow(
          ...
          children: [
            _metaCell('Station', report.stationName),
            _metaCell('Report Type', report.reportType.replaceAll('_', ' ')),
            _metaCell('Period', period),
            _metaCell(
              'Generated By',
              report.generatedByName.isNotEmpty
        ...
        pw.TableRow(
          ...
          children: [
            _metaCell('Report Title', title),
            _metaCell('Month/Year', '${report.month}/${report.year}'),
            _metaCell('Generated At', timestamp),
            _metaCell('Reference', _reportReference(report)),
          ],
        ),
      ],
    );
      ...
      rows.add(
        pw.Row(
          children: [
            ...
            pw.SizedBox(width: 6),
            pw.Expanded(
              child: i + 1 < cells.length ? cells[i + 1] : pw.SizedBox(),
            ),
          ],
        ),
      );
  ...
  static pw.Widget _buildDataTable(
    ...
    return pw.Table(
      border: pw.TableBorder.all(color: borderColor, width: 0.5),
      columnWidths: {
        for (var i = 0; i < keys.length; i++) i: pw.FlexColumnWidth(1),
      },
      children: [
        pw.TableRow(
  ...
  static String _formatMap(Map value) {
    ...
    final parts = value.entries.map(
      (e) => '${_formatLabel(e.key.toString())}: ${_formatValue(e.value)}',
    );
